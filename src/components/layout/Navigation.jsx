...
// Iconos SVG con colores profesionales
const IconHome = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M12 2L2 7V10H3V20H9V14H15V20H21V10H22V7L12 2Z" fill="#2c3e50" stroke="#1a252f" strokeWidth="1"/>
  </svg>
);

const IconUsers = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <circle cx="9" cy="7" r="4" fill="#7f8c8d" stroke="#5d6d7e" strokeWidth="1"/>
    <path d="M1 21V19C1 16.7909 2.79086 15 5 15H13C15.2091 15 17 16.7909 17 19V21" fill="#7f8c8d" stroke="#5d6d7e" strokeWidth="1"/>
    <circle cx="17" cy="7" r="3" fill="#95a5a6" stroke="#7f8c8d" strokeWidth="1"/>
    <path d="M23 21V19.5C23 17.567 21.433 16 19.5 16" fill="#95a5a6" stroke="#7f8c8d" strokeWidth="1"/>
  </svg>
);

const IconTruck = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <rect x="1" y="8" width="13" height="8" rx="1" fill="#27ae60" stroke="#1e8449" strokeWidth="1"/>
    <path d="M14 8V12H20L18 8H14Z" fill="#27ae60" stroke="#1e8449" strokeWidth="1"/>
    <circle cx="6" cy="18" r="2" fill="#2c3e50" stroke="#1a252f" strokeWidth="1"/>
    <circle cx="18" cy="18" r="2" fill="#2c3e50" stroke="#1a252f" strokeWidth="1"/>
  </svg>
);

const IconClients = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <rect x="3" y="4" width="18" height="12" rx="2" fill="#3498db" stroke="#2980b9" strokeWidth="1"/>
...
const IconCalendar = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <rect x="3" y="4" width="18" height="16" rx="2" fill="#f39c12" stroke="#d68910" strokeWidth="1"/>
    <path d="M16 2V6M8 2V6" stroke="#d68910" strokeWidth="2" strokeLinecap="round"/>
    <path d="M3 10H21" stroke="#d68910" strokeWidth="2"/>
...
const IconBoxes = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M2 12L12 17L22 12" fill="#5dade2" stroke="#3498db" strokeWidth="1"/>
  </svg>
);
